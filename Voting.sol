...
//Homework - Ethereum Project Univ. Nicosia

contract Voting {
    // an event that is called whenever a Candidate is added so the frontend could
    //  display the candidate with the right element id (it is used
    // to vote for the candidate, since it is one of arguments of the function "vote")
    ...
    // calculates all the votes of a specific candidate by looping
    // through voters 
